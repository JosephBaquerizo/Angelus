		...
		<div className='contactContainer' id='ContactContainer'>
			<div className='contactForm'>	
				<div className='contactTitle'>
					<p className='contactText'>¡Contáctate con nosotros!</p>
				</div>
				<div className='form'>
					<div className='formText'>
						<label>Nombre</label>
						<input className='name' type='text' placeholder='Ingresa tu nombre'/>
					</div>
					...
					<div className='formText'>
						<label>Correo</label>
						<input className='email' type='email' placeholder='Ingresa tu correo'/>
					</div>
					<div className='alertDiv'>
					...
					<div className='formText'>
						<label>Mensaje</label>
						<textarea className='message' placeholder='Ingresa tu mensaje'></textarea>
					</div>
					<div className='alertDiv'>
						<p className='alert redMessage'>Mensaje ingresado inválido*</p>
					</div>
					<div className='btnArea'>
						<button onClick={this.handleSubmit} className='submitBtn'>Enviar</button>
